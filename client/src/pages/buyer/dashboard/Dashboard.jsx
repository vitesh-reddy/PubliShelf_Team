...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {/* Auction Countdown Cards Section */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-gray-900">Live & Upcoming Auctions</h2>
                  <p className="text-gray-600">Don't miss out on these exclusive opportunities</p>
                </div>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[...data.ongoingAuctions, ...data.upcomingAuctions].slice(0, 6).map((auction) => (
                <AuctionCountdownCard
                  key={auction._id}
                  auction={auction}
                  onClick={() => navigate(`/buyer/auction-ongoing/${auction._id}`)}
                />
              ))}
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900">Newly Added Books</h2>
                </div>
              ...
              {viewMode === 'grid' ? (
                ...
                <ShelfView books={data.newlyBooks.slice(0, 6)} onClick={(id) => navigate(`/buyer/product-detail/${id}`)} />
              )}
            </section>
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900">Most Sold Books</h2>
                </div>
                <ShelfViewToggle view={viewMode} onViewChange={setViewMode} />
              </div>
              {viewMode === 'grid' ? (
                ...
                <ShelfView books={data.mostSoldBooks.slice(0, 6)} onClick={(id) => navigate(`/buyer/product-detail/${id}`)} />
              )}
            </section>
            ...
            <section>
              ...
              {viewMode === 'grid' ? (
                ...
                <ShelfView books={data.trendingBooks.slice(0, 6)} onClick={(id) => navigate(`/buyer/product-detail/${id}`)} />
              )}
            </section>
          </div>
