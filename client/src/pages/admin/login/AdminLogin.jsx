...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await loginAdmin({ adminKey });
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  required
                  autoFocus
                  className="appearance-none block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent placeholder-gray-400 transition-all duration-300"
            ...
            <button
              ...
              } focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-300 transform hover:-translate-y-0.5`}
            >
              {loading ? (
                <>
