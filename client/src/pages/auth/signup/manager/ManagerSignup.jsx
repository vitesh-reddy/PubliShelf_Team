...
const ManagerSignup = () => {
  ...
  const criteria = {
    ...
    special: { ok: /[^A-Za-z0-9]/.test(passwordValue), hint: "Add a special character (e.g. !@#$%)" },
  };
          ...
          <div className="bg-white p-8 shadow-lg rounded-xl space-y-6 animate-fade-in">
            ...
            <div className="relative">
              ...
              <div className="mt-1 relative">
                ...
                >
                  <i className={`fas ${showPassword ? "fa-eye-slash" : "fa-eye"} text-gray-400`} />
                </button>
              </div>
                  ...
                  <div className="absolute top-[2px] inset-x-0 flex flex-row-reverse justify-between items-center">
                    ...
                    <div className="h-5 mt-2 overflow-hidden relative w-[80%]">
                      {(() => {
                        ...
                        const nextReq = ordered.find((c) => !c.ok);
              ...
              {/* Password Error (same as Buyer & Publisher) */}
              {errors.password && (
